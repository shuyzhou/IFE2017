...
/***/ function(module, exports, __webpack_require__) {
	...
	var Picker = function () {
		function Picker(el) {
			...
			this.panel = new _Panel2.default('#panel', '#00ffff');
			this.stripe = new _Stripe2.default('#stripe');
			this.colorValue = new _ColorValue2.default('#colorValue', {
				r: 0,
				g: 255,
				b: 237,
				h: 0.49,
		...
		(0, _createClass3.default)(Panel, [{
			...
			value: function init() {
				...
				this.el.addEventListener('click', function (e) {
					...
					//触发颜色改变事件
					var color = _util2.default.getColor(this.ctx, x, y);
					_watcher2.default.trigger('colorChange', color);
				}.bind(this));
			}
		}, {
			key: 'render',
			value: function render(color, x, y) {
				this.color = color;
...
/***/ function(module, exports) {
	...
	exports.default = {
		getColor: function getColor(ctx, x, y) {
			var data = ctx.getImageData(x, y, 1, 1);
			var color = "rgb(" + data.data[0] + "," + data.data[1] + "," + data.data[2] + ")";
			return color;
		},
		getRGBValue: function getRGBValue(color) {
		...
		(0, _createClass3.default)(Stripe, [{
			...
			value: function init() {
				...
				this.el.addEventListener('click', function (e) {
					...
					this.render(12.5, y);
					//触发色带改变事件
					var color = _util2.default.getColor(this.ctx, 12, y);
					_watcher2.default.trigger('areaChange', color);
				}.bind(this));
			}
		}, {
			key: 'render',
	...
	var ColorValue = function () {
		...
		(0, _createClass3.default)(ColorValue, [{
			...
			value: function change(color) {
				var _util$getRGBValue = _util2.default.getRGBValue(color),
				    _util$getRGBValue2 = (0, _slicedToArray3.default)(_util$getRGBValue, 3),
				    r = _util$getRGBValue2[0],
				    g = _util$getRGBValue2[1],
				    b = _util$getRGBValue2[2];

				var _util$rgb2HSL$map = _util2.default.rgb2HSL(r, g, b).map(function (val) {
					return val.toFixed(2);
				}),
				    _util$rgb2HSL$map2 = (0, _slicedToArray3.default)(_util$rgb2HSL$map, 3),
				    h = _util$rgb2HSL$map2[0],
				    s = _util$rgb2HSL$map2[1],
				    l = _util$rgb2HSL$map2[2];
